...
// MaybeGet AFAIRE
func (v *Value) MaybeGet(keys ...string) (*Value, error) {
	_, value, err := v.Get(keys...)
	if err != nil {
...
func (v *Value) MapString(keys ...string) (map[string]*Value, error) {
	...
	if !ok {
		return nil,
			failure.New(nil).
				Set("pointer", ptr).
				Msg("this pointer do not reference a map") /////////////////////////////////////////////////////////////
	}
...
func (v *Value) Slice(keys ...string) ([]*Value, error) {
	...
	if !ok {
		return nil,
			failure.New(nil).
				Set("pointer", ptr).
				Msg("this pointer do not reference a slice") ///////////////////////////////////////////////////////////
	}
